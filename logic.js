...
const scenes = {
  ...
  'phone_check': {
    ...
    dialogue: [
      ...
      { speaker: 'Narrator', text: "And one from Navi ettan." },
      { speaker: 'Narrator', text: "Sent at exactly midnight." },
      { speaker: 'Narrator', text: "It says: 'Happy Birthday, Vedu." },
      { speaker: 'Narrator', text: "Don't stay up too late tonight. 💛'" },
  ...
  'morning_music': {
    ...
    dialogue: [
      ...
      { speaker: 'Narrator', text: "It's been your alarm, your commute..." },
      { speaker: 'Narrator', text: "Basically your entire personality for 3 months." },
  ...
  'morning_window': {
    ...
    dialogue: [
      ...
      { speaker: 'Narrator', text: "Not metaphorically. Actually out. Blooming." },
      { speaker: 'Vedu', text: "Why does this feel like a K-drama scene." },
      { speaker: 'Narrator', text: "A petal drifts through the window and lands on your nose." },
      { speaker: 'Vedu', text: "..." },
  ...
  'town_arrival': {
    ...
    dialogue: [
      ...
      { speaker: 'Narrator', text: "Like someone turned up the saturation on everything." },
      { speaker: 'Vedu', text: "Is this how it always looks?" },
      { speaker: 'Narrator', text: "A small figure watches from behind a flower stall." }
    ],
    next: 'star_cat_appears'
  },
  'star_cat_appears': {
    ...
    dialogue: [
      ...
      { speaker: 'Vedu', text: "I'm being given life advice by a purple cat." },
  ...
  'music_path': {
    ...
    dialogue: [
      ...
      { speaker: 'Narrator', text: "It leads to a small music studio." },
      { speaker: 'Narrator', text: "One you've never noticed before." },
      { speaker: 'Vedu', text: "This has definitely always been here." },
  ...
  'golden_scene': {
    ...
    dialogue: [
      ...
      { speaker: 'Narrator', text: "You stand there, in a room that doesn't exist," },
  ...
  'savage_scene': {
    ...
    dialogue: [
      ...
      { speaker: 'Vedu', text: "I need to do something dramatic right now." },
  ...
  'new_song_scene': {
    ...
    dialogue: [
      ...
      { speaker: 'Narrator', text: "It's soft. Then warm." },
      { speaker: 'Narrator', text: "It hits a note that makes your chest ache a little." },
  ...
  'garden_path': {
    ...
    dialogue: [
      ...
      { speaker: 'Narrator', text: "It's enormous. Absolutely full of flowers." },
      { speaker: 'Vedu', text: "This is either very beautiful or I'm still dreaming." }
    ],
    next: 'garden_path_2'
  },
  'garden_path_2': {
  ...
  'feeling_grateful': {
    ...
    dialogue: [
      ...
      { speaker: 'Narrator', text: "The family group chat that never sleeps." },
  ...
  'feeling_excited': {
    ...
    dialogue: [
      ...
      { speaker: 'Vedu', text: "New music. New phases." },
      { speaker: 'Vedu', text: "New things to obsess over for 3 days." },
      { speaker: 'Bunny', text: "That sounds exhausting." },
      { speaker: 'Vedu', text: "That sounds AMAZING." },
      { speaker: 'Bunny', text: "Also true." },
      { speaker: 'Narrator', text: "The flower you pick is bright pink." }
    ],
    next: 'act3_convergence'
  },
  'feeling_warm': {
    ...
    dialogue: [
      ...
      { speaker: 'Narrator', text: "It's rose pink with a golden center." },
  ...
  'act3_convergence': {
    ...
    dialogue: [
      ...
      { speaker: 'Narrator', text: "But it feels familiar in a strange way." },
  ...
  'ettan_appears': {
    ...
    dialogue: [
      ...
      { speaker: 'Navi ettan', text: "Even in your dream, I had to show up at midnight." },
  ...
  'ettan_letter': {
    ...
    dialogue: [
      ...
      { speaker: 'Navi ettan', text: "Your taste, your confidence, your weird phases." },
      { speaker: 'Navi ettan', text: "The way you care about things." },
      { speaker: 'Navi ettan', text: "Every song you've loved. Every obsession." },
      { speaker: 'Navi ettan', text: "Just different versions of you being fully alive." },
      ...
      { speaker: 'Navi ettan', text: "And yes, I will be stealing the aux cord." },
  ...
  'wake_up_final': {
    ...
    dialogue: [
      ...
      { speaker: 'Narrator', text: "Sent at exactly midnight." },
      { speaker: 'Narrator', text: "'Happy Birthday, Vedu. Don't stay up too late. 💛'" },
  ...
  'ending_screen': {
    ...
    onEnter: () => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          const btnData = [
            { t: '♺ Play Again', c: () => window.location.reload() },
            { t: 'Go! 💛', c: () => window.close() }
          ];
...
function resizeGame() {
  ...
  if (isPortrait) {
    state.scale = Math.min(h / 480, w / 270) * 0.98;
    container.style.transform = `scale(${state.scale}) rotate(90deg)`;
  } else {
    state.scale = Math.min(w / 480, h / 270) * 0.98;
...
document.addEventListener('touchstart', (e) => {
  if (e.target.closest('.choice-btn') || e.target.closest('#title-screen') || e.target.closest('#mute-btn')) return;
